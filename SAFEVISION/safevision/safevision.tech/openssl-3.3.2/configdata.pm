...
our %config = (
    ...
    "perlargv" => [
        ...
        "no-shared",
        "no-tests",
        "--prefix=/home/safevision/Desktop/safevision.tech/app/src/main/cpp/openssl3_include"
    ],
    "perlenv" => {
        "AR" => "llvm-ar",
        "ARFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/home/safevision/Desktop/safevision.tech/openssl-3.3.2/util/perl';
    use OpenSSL::fallback '/home/safevision/Desktop/safevision.tech/openssl-3.3.2/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/safevision/Desktop/safevision.tech/openssl-3.3.2/Configurations';
        use gentemplate;
